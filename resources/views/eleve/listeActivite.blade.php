        ...
        <x-card-large>
            ...
            <div>
                <div class="w-full mt-6 flex items-end">
                    <x-button-danger v-if="filtre.placeRestante < 1 && functionIsInscrit(filtre) == false && filtre.activiteAnnule == false" disabled>Complet</x-button-danger>

                    <x-button-primary v-if="functionIsInscrit(filtre) == false && filtre.placeRestante > 0 && filtre.activiteAnnule == false" @click="allerInscription(filtre.codeType, filtre.idActivite)">S'inscrire</x-button-primary>

                    <x-button-success v-if="functionIsInscrit(filtre) == true && filtre.activiteAnnule == false" @click="allerDesinscription(filtre.codeType, filtre.idActivite)">Inscrit 🎉</x-button-success>

                    <x-button-cancel v-if="filtre.activiteAnnule == true" disabled>Activité annulée ❌</x-button-cancel>
